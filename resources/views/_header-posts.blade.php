        ...
        <div class="relative lg:inline-flex bg-gray-100 rounded-xl">
            ...
            <div x-data="{ show:false }" @click.away="show=false">
                ...
                <button @click="show = !show"
                        class="py-2 pl-3 pr-9 text-sm font-semibold w-full lg:w-32
                ...
                <div x-show="show" class="py-2 absolute bg-gray-100 w-full rounded-xl m-1 z-50"
                     style="display: none">
                    <a href="#" class="block text-left px-3 text-sm leading-6 hover:bg-blue-300
                        focus:bg-blue-300 hover:text-white focus:text-white">One</a>
                    <a href="#" class="block text-left px-3 text-sm leading-6 hover:bg-blue-300
                        focus:bg-blue-300 hover:text-white focus:text-white">One</a>
                    <a href="#" class="block text-left px-3 text-sm leading-6 hover:bg-blue-300
                        focus:bg-blue-300 hover:text-white focus:text-white">Highest Valueueuuee</a>
                </div>
            </div>
